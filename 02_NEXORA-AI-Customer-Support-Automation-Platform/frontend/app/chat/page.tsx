  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: "welcome",
      content:
        "Welcome to NEXORA AI Support! I'm your AI assistant. Ask me anything. If I can't help, I'll connect you with a human agent.",
      sender_type: "ai",
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-text-primary">
                  {escalated ? "Live Agent -- Sarah" : "NEXORA AI Assistant"}
                </h3>
                    ...
                    {!isUser && (
                      <div className="flex items-center gap-1.5 mb-1">
                        <span className="text-xs font-medium text-text-muted">
                          {msg.sender_type === "ai" ? "NEXORA AI" : "Sarah (Agent)"}
                        </span>
