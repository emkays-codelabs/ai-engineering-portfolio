...
export default function SettingsPage() {
  ...
  const [systemPrompt, setSystemPrompt] = useState(
    "You are a helpful customer support assistant for NEXORA AI Support Copilot. Answer questions based on the knowledge base. Be concise, professional, and accurate."
  );

  // General settings
  const [supportEmail, setSupportEmail] = useState("support@nexora-ai.ai");
